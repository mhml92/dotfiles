...
" Vim session script.
" Created by session.vim 2.13.1 on 11 September 2016 at 19:26:33.
...
set shortmess=aoO
badd +34 include/TransClust.hpp
...
setlocal fen
silent! normal! zE
let s:l = 76 - ((7 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
setlocal fen
silent! normal! zE
let s:l = 73 - ((32 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
